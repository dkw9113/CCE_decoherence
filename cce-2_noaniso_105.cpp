...
int main(){
	...
	read_file_to_Eigen(ga69_loc,"69Ga_dist_z0_5_l0_10.dat", nga69, 3);
	read_file_to_Eigen(ga71_loc,"71Ga_dist_z0_5_l0_10.dat", nga71, 3);
	read_file_to_Eigen(as75_loc,"75As_dist_z0_5_l0_10.dat", nas75, 3);
...
/*From L. Cywinski et al., PRB 09, hf-mediated*/
	...
	VectorXd t=VectorXd::LinSpaced(11,0,10000);
	//cout<<"ROSJA"<<"\n";
	cx_vec W1(t.size());
	cx_vec W2(t.size());
	//vec Wan(t.size());
