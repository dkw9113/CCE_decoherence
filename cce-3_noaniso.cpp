...
int main(){
	...
	W3=W3%(cce3(hamplus3, hamminus3, Uplus3, Uminus3, t, A1,omega1, bij)/((W12/(W11%W21))%(cce2(hamplus2, hamminus2, Uplus2, Uminus2, t, {A1[1],A1[2]}, {omega1[1],omega1[2]}, bij[1])/(W21%W31))%(cce2(hamplus2, hamminus2, Uplus2, Uminus2, t, {A1[0], A1[2]}, {omega1[0], omega1[2]}, bij[2])/(W11%W31))%W11%W21%W31));
	...
	for(int i=0;i<t.size();i++){
		cout<<W1[i]<<"\t"<<W2[i]<<"\t"<<W3[i]<<"\t"<<Wan[i]<<"\t"<<Wan_py(i,1)<<"\n";
