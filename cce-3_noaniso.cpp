...
int main(){
	...
	W3%cce3(hamplus3, hamminus3, Uplus3, Uminus3, t, A1,omega1, bij)/((W21/(W11%W21))%(cce2(hamplus2, hamminus2, Uplus2, Uminus2, t, {A1[1],A1[2]}, {omega1[1],omega1[2]}, bij[1])/(W21%W31))%(cce2(hamplus2, hamminus2, Uplus2, Uminus2, t, {A1[0], A1[2]}, {omega1[0], omega1[2]}, bij[2])/(W11%W31))%W11%W21%W31);
