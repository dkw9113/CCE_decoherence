...
int main(){
	...
	read_file_to_Eigen(ga69_loc,"69Ga_dist_z010_l0_10_neigh_12.dat", nga69, 3);
	read_file_to_Eigen(ga71_loc,"71Ga_dist_z010_l0_10_neigh_12.dat", nga71, 3);
	read_file_to_Eigen(as75_loc,"75As_dist_z010_l0_10_neigh_12.dat", nas75, 3);
...
/*From L. Cywinski et al., PRB 09, hf-mediated*/
	...
	//cout<<i<<"\n";
	j=i+1;
	while(j<N){if((ga69_loc.row(j)-ga69_loc.row(i)).norm()<R){
	//cout<<"i: "<<i<<" j: "<<j<<"\n";
	...
	//cout<<i<<"\n";
	j=i+1;
	while(j<N){if((ga71_loc.row(j)-ga71_loc.row(i)).norm()<R){
	//cout<<"i: "<<i<<" j: "<<j<<"\n";
	...
	//cout<<i<<"\n";
	j=i+1;
	while(j<N){if((as75_loc.row(j)-as75_loc.row(i)).norm()<R){
	//cout<<"i: "<<i<<" j: "<<j<<"\n";
