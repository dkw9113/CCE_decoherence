...
int main(){
	...
	VectorXd t=VectorXd::LinSpaced(101,0,10000);
	//cout<<"ROSJA"<<"\n";
	cx_vec W1(t.size());
	cx_vec W11(t.size());
	cx_vec W21(t.size());
	...
	W3=W3%W13;
	//cout<<abs(cce3(hamplus3, hamminus3, Uplus3, Uminus3, t, Axz1, Ayz1, Azz1, omega1, bij))-1<<endl;
	//W3=W3%(cce3(hamplus3, hamminus3, Uplus3, Uminus3, t, Axz1, Ayz1, Azz1, omega1, bij)/((W12)%(cce2(hamplus2, hamminus2, Uplus2, Uminus2, t, {Axz1[1],Axz1[2]}, {Ayz1[1],Ayz1[2]}, {Azz1[1],Azz1[2]}, {omega1[1],omega1[2]}, bij[1]))%(cce2(hamplus2, hamminus2, Uplus2, Uminus2, t, {Axz1[0], Axz1[2]}, {Ayz1[0], Ayz1[2]}, {Azz1[0], Azz1[2]}, {omega1[0], omega1[2]}, bij[2]))%W11%W21%W31));
	//cout<<W3<<endl;
	A1.pop_back();
	Axz1.pop_back();
	Ayz1.pop_back();
